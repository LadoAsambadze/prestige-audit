      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          <div className="lg:col-span-3">
            <Card className="rounded-[40px] p-10 border-none shadow-sm h-full flex flex-col justify-center bg-white">
              ...
              <p className="text-gray-500 mb-8 text-sm leading-relaxed">
                Ad litora torquent per conubia nostra inceptos himenaeos. Dis
                parturient montes.
              </p>
          ...
          <div className="lg:col-span-6 relative">
            <div className="hidden lg:grid grid-cols-2 gap-6 h-[600px] overflow-hidden relative scroll-container">
            ...
            <div className="block lg:hidden relative h-[420px] overflow-hidden rounded-[32px] scroll-container">
              <div className="absolute inset-x-0 top-0 h-16 bg-gradient-to-b from-[#f3f5f4] to-transparent z-20 pointer-events-none" />
              <div className="absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-[#f3f5f4] to-transparent z-20 pointer-events-none" />
          ...
          <div className="lg:col-span-3 flex flex-col gap-6">
            <Card className="rounded-[40px] p-8 text-center border-none bg-white shadow-sm flex-1 flex flex-col justify-center">
              ...
              <div className="flex justify-center gap-5 opacity-60">
                ...
                <span className="font-bold text-xl text-red-500">Y</span>
              </div>
            </Card>

            <Card className="rounded-[40px] p-8 bg-[#dbeafe] border-none relative overflow-hidden flex-1">
